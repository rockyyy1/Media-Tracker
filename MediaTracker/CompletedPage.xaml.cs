...
public partial class CompletedPage : ContentPage
{
	public CompletedPage()
	{
        ...
        MovieList.ItemsSource = LibraryPage.Instance.movieList
            .Where(m => m.UserStatus == UserStatusEnum.COMPLETED).ToList();
    ...
    private void OnLibraryUpdated(object sender, EventArgs e)
    {
        ...
        MovieList.ItemsSource = LibraryPage.Instance.movieList.Where(m => m.UserStatus == UserStatusEnum.COMPLETED).ToList();
        TVShowList.ItemsSource = LibraryPage.Instance.tvShowList.Where(m => m.UserStatus == UserStatusEnum.COMPLETED).ToList();
        BookList.ItemsSource = LibraryPage.Instance.bookList.Where(m => m.UserStatus == UserStatusEnum.COMPLETED).ToList();
    }
